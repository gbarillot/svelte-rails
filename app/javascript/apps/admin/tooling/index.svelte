<script>
	import { Store, Api } from '../stores/dashboard'		
...
<section class="container">
	<div class="row">
		...
		<div class="col-xs-12 col-md-3 card">
			<h3>Axios</h3>
			<p><a href="https://axios-http.com/docs/intro" target="_blank">Handles AJAX requests</a></p>
		</div>
		<div class="col-xs-12 col-md-3 card">
			<h3>Vite</h3>
		...
		<div class="col-xs-12 col-md-3 card">
			...
			<p><a href="https://kazupon.github.io/vue-i18n/" target="_blank">
				{ $_('dashboard.movies', {values: { n: 0 }}) }, 
				{ $_('dashboard.movies', {values: { n: 1 }}) }, 
				{ $_('dashboard.movies', {values: { n: $Store.metrics.movies }}) }</a>
			</p>
		</div>
		<div class="col-xs-12 col-md-3 card">
			<h3>ActionCable</h3>
